...
public class Brook implements EntryPoint {
	...
	private void startApp() {
		if (phoneGap.isPhoneGapDevice()) {
			PhonegapUtil.prepareService((ServiceDefTarget)dataService, 
					Config.APP_HOST_DOMAIN , "brook/dataService");
		}
	...
	public void goToHome() {
		...
		historyHandler.register(clientFactory.getPlaceController(),
				clientFactory.getEventBus(), Config.ADMIN_MODE ? new AdminPlace(null, null) : new HomePlace());
